...
/*
 ...
 Плюсы:
 Упрощает использование подсистемы за счёт уменьшения времени на изучение подсистемы.
 Способствует уменьшению степени связанности между подсистемой и клиентом (клиентами).
